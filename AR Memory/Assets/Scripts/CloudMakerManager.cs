...
public class CloudMakerManager : MonoBehaviour {
	...
	public void SpawnRandomCloud(){
		GameObject cloud = Instantiate(Resources.Load("cloud"), new Vector3(transform.position.x, Random.Range(20,40), Random.Range(-10,50)), Quaternion.identity) as GameObject;
